...
namespace Novenen.ViewModels
{
	...
	public class ScheduleViewModel
	{
		...
		private void CreateEventNameCollection()
		{
			...
			eventNameCollection.Add("Therapy");
			eventNameCollection.Add("Plan Execution");
			eventNameCollection.Add("Project Plan");
			eventNameCollection.Add("Consulting");
			eventNameCollection.Add("Performance Check");
		...
		private void CreateColorCollection()
		{
			...
			colorCollection.Add(Xamarin.Forms.Color.Red);
			colorCollection.Add(Xamarin.Forms.Color.Black);
			colorCollection.Add(Xamarin.Forms.Color.Aqua);
			colorCollection.Add(Xamarin.Forms.Color.Beige);
			colorCollection.Add(Xamarin.Forms.Color.Chocolate);
			colorCollection.Add(Xamarin.Forms.Color.DarkGreen);
			colorCollection.Add(Xamarin.Forms.Color.ForestGreen);
			colorCollection.Add(Xamarin.Forms.Color.Gold);
			colorCollection.Add(Xamarin.Forms.Color.HotPink);
			colorCollection.Add(Xamarin.Forms.Color.IndianRed);
			colorCollection.Add(Xamarin.Forms.Color.Khaki);
